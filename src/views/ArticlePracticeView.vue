      ...
      <header class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-10">
        <div class="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            <button v-if="article?.translation" @click="showTranslation = !showTranslation" class="px-3 py-1.5 text-sm bg-emerald-100 dark:bg-emerald-900 text-emerald-600 dark:text-emerald-300 rounded-lg hover:bg-emerald-200 dark:hover:bg-emerald-800 transition-colors">
          ...
          <div class="flex flex-wrap gap-2">
            <span v-for="(unit, index) in units" :key="index" 
              ...
              :class="{
                ...
                'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 ring-2 ring-emerald-500': unit.status === 'current',
        ...
        <div class="flex items-center justify-center gap-2 mb-3">
          ...
          <span v-if="currentUnit" class="inline-flex flex-wrap items-center justify-center gap-0.5">
            <span v-for="(item, charIndex) in addRubyToText(currentUnit)" :key="charIndex" class="ruby-wrapper">
              ...
              <span class="base-text text-emerald-700 dark:text-emerald-300">{{ item.char }}</span>
            </span>
          </span>
        </div>
